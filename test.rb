...
describe Game do
	...
	describe "#transform_aliveness" do
		it "returns the correct aliveness status for the next turn" do
			expect(subject.transform_aliveness(1,1) == 0)
			expect(subject.transform_aliveness(1,3) == 1)
			expect(subject.transform_aliveness(1,4) == 0)
			expect(subject.transform_aliveness(0,3) == 1)
			expect(subject.transform_aliveness(0,5) == 0)
		end
	end
